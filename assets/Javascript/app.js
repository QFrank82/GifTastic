$(document).ready(function(){
    ...
    var movies = ["Xmen", "ThunderCats", "TMNT", "Gargoyles", "BTAS", "Animaniacs", "DuckTales", "The Simpsons", "Transformers", "Voltron"]
    GIFArea = " "
    ...
    //==============DISPLAY INFO==============================
        $(document).on('click', 'button',  function() {
            ...
            // (this is necessary otherwise we will have repeat buttons)
                ...
                var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + b + "&api_key=q6qHx8t8OJ96dpSvPCttbd6GMPXl3y02&limit=10";  //query api url and public key
